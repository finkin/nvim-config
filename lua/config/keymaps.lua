...
map("v", "<leader>a", ":CodeCompanionChat Toggle<CR>", "AI Chat")
map("n", "<C-a>", "<cmd>CodeCompanionActions<cr>", "AI Actions")
map("v", "<C-a>", "<cmd>CodeCompanionActions<cr>", "AI Actions")
map("v", "ga", "<cmd>CodeCompanionChat Add<cr>", "AI Send to chat")
